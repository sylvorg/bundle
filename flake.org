...
#+begin_src nix
    in with lib; mkOutputs {
        inherit inputs;
        pname = "settings";
        callPackage = { stdenv, pname }: stdenv.mkDerivation rec {
            inherit pname;
            version = "1.0.0.0";
            src = ./.;
            phases = [ "installPhase" ];
            ...
            makeWrapperArgs = toList "--set PATH ${makeBinPath [ inputs.nixos-unstable.legacyPackages.${stdenv.targetPlatform.system}.emacs ]}";
        };
